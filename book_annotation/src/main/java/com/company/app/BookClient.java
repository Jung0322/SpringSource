...
public class BookClient {
	...
	public static void main(String[] args) {
		...
		//새로운 도서 입력
//		BookDTO insertDto = new BookDTO("1006","스프링","구멍가게",32000);
//		System.out.println(service.insertBook(insertDto)?"입력성공":"입력실패");
		
		// update
		System.out.println(service.update("1002",35000)?"수정성공":"수정실패");
		//delete
		System.out.println(service.detele("1006")?"삭제성공":"삭제실패");
		//전체 리스트 결과 호출
